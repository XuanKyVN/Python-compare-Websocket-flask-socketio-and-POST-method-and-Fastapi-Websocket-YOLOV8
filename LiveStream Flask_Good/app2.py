...
cap3 =cv2.VideoCapture(r"C:\Users\Admin\PythonLession\pic\Traffic3.mp4")

cap4 =cv2.VideoCapture(r"C:\Users\Admin\PythonLession\pic\Traffic4.mp4")
...
def video_feed2():
     return Response(generate(cap3),
          mimetype = "multipart/x-mixed-replace; boundary=frame")

@app.route("/video_feed3")
def video_feed3():
     return Response(generate(cap4),
          mimetype = "multipart/x-mixed-replace; boundary=frame")
